...
class Tracable(torch.nn.Module):
    def __init__(self, config: dict):
        ...
        self.model = AutoModelForSeq2SeqLM.from_pretrained(model_name, return_dict=False, torchscript=True).float().cpu()
...
torch.jit.save(converted, "./traced_translation_cpu.pt")
