...
public final class UNetHumanSegModel implements AutoCloseable {
    ...
    public UNetHumanSegModel(String modelPath, String modelName, int poolSize, boolean mask, boolean isPostProcess, Device device) throws ModelException, IOException {
