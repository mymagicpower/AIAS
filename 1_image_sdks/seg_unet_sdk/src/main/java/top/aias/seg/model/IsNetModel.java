...
import top.aias.seg.translator.IsNetTranslator;
...
public final class IsNetModel implements AutoCloseable {
    ...
    public IsNetModel(String modelPath, String modelName, int poolSize, boolean mask, boolean isPostProcess, Device device) throws ModelException, IOException {
    ...
    private Criteria<Image, Image> criteria(String modelPath, String modelName, boolean mask, boolean isPostProcess, Device device) {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optDevice(device)
                        .optTranslator(new IsNetTranslator(mask, isPostProcess))
