 ...
 */
public final class MlsdSquarePt implements AutoCloseable {
    ...
    public MlsdSquarePt(Device device, boolean drawSquare) throws ModelException, IOException {
        this.device = device;
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("models/mlsd_traced_model.pt"))
                        .optDevice(device)
