...
import me.aias.example.utils.SmallSafetyHelmetDetect;
...
public final class SmallSafetyHelmetDetectExample {
  ...
  private static final Logger logger = LoggerFactory.getLogger(SmallSafetyHelmetDetectExample.class);

  private SmallSafetyHelmetDetectExample() {}
