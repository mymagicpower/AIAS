...
import me.aias.example.utils.Yolov5lDetect;
 ...
 * @author Calvin
 */
public final class Yolov5lExample {

  private static final Logger logger = LoggerFactory.getLogger(Yolov5lExample.class);

  private Yolov5lExample() {}

  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path imageFile = Paths.get("src/test/resources/demo.jpg");
    Image image = ImageFactory.getInstance().fromFile(imageFile);

    Criteria<Image, DetectedObjects> criteria = new Yolov5lDetect().criteria();
...
//        }
      ...
      ImageUtils.saveBoundingBoxImage(image, detections, "helmet_head_person_l.png", "build/output");
