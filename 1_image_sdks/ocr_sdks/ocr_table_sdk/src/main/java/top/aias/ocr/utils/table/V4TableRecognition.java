 ...
 */
public final class V4TableRecognition implements AutoCloseable {

  ZooModel model;
  Predictor<Image, TableResult> predictor;
  private Device device;

  public V4TableRecognition(Device device) throws ModelException, IOException {
    this.device = device;
  ...
  private Criteria<Image, TableResult> criteria() {
    ...
    Criteria<Image, TableResult> criteria =
        Criteria.builder()
            ...
            .optModelPath(Paths.get("models/ch_ppstructure_mobile_v2.0_SLANet_infer.zip"))
            .optOption("removePass", "repeated_fc_relu_fuse_pass")
            .optDevice(device)
            .optTranslator(new V4TableStructTranslator(new ConcurrentHashMap<String, String>()))
