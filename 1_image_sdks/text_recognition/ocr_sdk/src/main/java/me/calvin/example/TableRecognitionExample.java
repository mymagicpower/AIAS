...
import me.calvin.ocr.ConvertHtml2Excel;
import me.calvin.ocr.MobileOcrRecognition;
 ...
 */
public final class TableRecognitionExample {

  private static final Logger logger = LoggerFactory.getLogger(TableRecognitionExample.class);

  private TableRecognitionExample() {}
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    ...
    try (ZooModel tableModel = ModelZoo.loadModel(tableDetection.criteria());
         Predictor<Image, ResultBean> tableDetector = tableModel.newPredictor();
      ...
      // 表格单元检测
      ResultBean result = tableDetector.predict(image);
