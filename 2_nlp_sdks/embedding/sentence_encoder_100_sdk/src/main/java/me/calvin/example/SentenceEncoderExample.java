...
import me.calvin.aias.util.SpProcessor;
import me.calvin.aias.util.SpTokenizer;
...
public final class SentenceEncoderExample {
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    ...
    URL url =
        new URL(
            "https://djl-model.oss-cn-hongkong.aliyuncs.com/models/nlp_models/sentence_transformers/sentencepiece.bpe.model");
