...
public final class WordEncoderExample9 {

  private static final Logger logger = LoggerFactory.getLogger(WordEncoderExample9.class);

  private WordEncoderExample9() {}

  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path vocabPath = Paths.get("src/test/resources/w2v_zhihu_dim300_vocab.txt");
    Path embeddingPath = Paths.get("src/test/resources/w2v_zhihu_dim300.npy");
