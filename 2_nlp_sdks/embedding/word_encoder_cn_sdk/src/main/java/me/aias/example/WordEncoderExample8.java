...
public final class WordEncoderExample8 {

  private static final Logger logger = LoggerFactory.getLogger(WordEncoderExample8.class);

  private WordEncoderExample8() {}

  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path vocabPath = Paths.get("src/test/resources/w2v_baidu_encyclopedia_dim300_vocab.txt");
    Path embeddingPath = Paths.get("src/test/resources/w2v_baidu_encyclopedia_dim300.npy");
