...
public final class WordEncoderExample3 {
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path vocabPath = Paths.get("src/test/resources/glove_wiki2014_gigaword_dim300_vocab.txt");
    Path embeddingPath = Paths.get("src/test/resources/glove_wiki2014_gigaword_dim300.npy");
