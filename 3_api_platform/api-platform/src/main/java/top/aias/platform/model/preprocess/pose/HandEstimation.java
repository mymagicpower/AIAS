...
public final class HandEstimation {
    ...
    public ArrayList<ArrayList<float[]>> hands(NDManager manager, HandModel handModel, NDArray oriImg, ArrayList<int[]> hands_list) throws TranslateException {
...
//                ImageUtils.saveImage(img, "hand_" + i + ".png", "build/output");
            ...
            ArrayList<float[]> peaks = estimation(manager, handModel, subImg);
    ...
    public ArrayList<float[]> estimation(NDManager manager, HandModel handModel, NDArray oriImg) throws TranslateException {
...
//            ImageUtils.saveImage(img, "hand_m_" + m + ".png", "build/output");
            ...
            NDArray ndArray = handModel.predict(img_padded);
