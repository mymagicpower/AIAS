package top.aias.platform.translator.asr;
 ...
 *
 */
public class AsrEncoderTranslator implements NoBatchifyTranslator<Audio, NDList> {

    private List<AudioProcessor> processors;
    private int kvLength;
    private int encoderIndex;
    public AsrEncoderTranslator(int kvLength, int encoderIndex) {
