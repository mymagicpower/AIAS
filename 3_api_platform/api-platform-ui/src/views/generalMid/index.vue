...
<script>
import { generalSegMidForImageUrl } from '@/api/inference'
...
export default {
  ...
  methods: {
    upload() {
      ...
      return `${process.env.VUE_APP_BASE_API}/api/seg/generalSegMidForImageFile`
    },
    submitUpload() {
    ...
    onSubmit() {
      this.fullscreenLoading = true
      generalSegMidForImageUrl(this.form).then(response => {
        this.fullscreenLoading = false
