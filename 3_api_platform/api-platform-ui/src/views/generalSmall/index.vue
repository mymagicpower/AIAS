...
<script>
import { generalSegSmallForImageUrl } from '@/api/inference'
...
export default {
  ...
  methods: {
    upload() {
      ...
      return `${process.env.VUE_APP_BASE_API}/api/seg/generalSegSmallForImageFile`
    },
    submitUpload() {
    ...
    onSubmit() {
      this.fullscreenLoading = true
      generalSegSmallForImageUrl(this.form).then(response => {
        this.fullscreenLoading = false
