...
import me.calvin.aias.PoseEstimation;
...
public final class PoseEstimationExample {
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    ...
    for (DetectedObjects.DetectedObject person : persons) {
      ...
      Joints joints = new PoseEstimation().predict(subImg);
    ...
    ImageUtils.saveImage(image, "pose-estimation.png", "build/output");
