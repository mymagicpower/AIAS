...
//        NDArray minValue = manager.create(Float.MIN_VALUE).toType(DataType.FLOAT16, true);
        next_token_scores = next_token_scores.toType(DataType.FLOAT32, false);
...
//        NDArray sorted_logits = next_token_scores.get(sorted_indices);
        ...
        next_token_scores = next_token_scores.toType(DataType.FLOAT16, false);
