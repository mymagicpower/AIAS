...
public final class Darknet53Classification {

  private static final Logger logger = LoggerFactory.getLogger(Darknet53Classification.class);

  public Darknet53Classification() {}

  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path imageFile = Paths.get("src/test/resources/cup.jpeg");
    Image img = ImageFactory.getInstance().fromFile(imageFile);

    Classifications classification = new Darknet53Classification().predict(img);
