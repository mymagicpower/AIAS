...
public final class BodyDetector implements AutoCloseable {
    ...
    public BodyDetector(int detect_resolution, int image_resolution, Device device) throws ModelException, IOException {
    ...
    private Criteria<Image, Image> ptCriteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("models/pytorch/body.pt"))
                        .optDevice(device)
