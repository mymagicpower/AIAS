...
public final class ControlNetPoseGpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("models/pytorch_gpu/", "controlnet_openpose.pt", Device.gpu());
             PoseDetector poseDetector = new PoseDetector(512, 512,Device.gpu());
             NDManager manager = NDManager.newBaseManager(Device.gpu());
             HandDetector handDetector = new HandDetector(Device.gpu());
             FaceDetector faceDetector = new FaceDetector(Device.gpu());) {
            ...
            ImageUtils.saveImage(result, "ctrlnet_pose_pt_gpu.png", "output");
        }
