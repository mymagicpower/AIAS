...
public final class LineArtCoarseDetector implements AutoCloseable {
    private int detect_resolution = 512;
    private int image_resolution = 512;
    ZooModel model;
    Predictor<Image, Image> predictor;
    private Device device;
    public LineArtCoarseDetector(int detect_resolution, int image_resolution, Device device) throws ModelException, IOException {
    ...
    public Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("models/pytorch/lineart_coarse.pt"))
                        .optDevice(device)
