...
public final class ControlNetInpaintGpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try(StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("models/pytorch_gpu/", "controlnet_inpaint.pt", Device.gpu());){
            Image result = model.generateImage(original_image,mask_image, prompt, negative_prompt, 25);
            ImageUtils.saveImage(result, "ctrlnet_inpaint_pt_gpu.png", "output");
        }
    }
}