...
public class PipelineLoraTxt2Img implements AutoCloseable {
    ...
    public PipelineLoraTxt2Img(String root, Device device) throws ModelException, IOException {
        this.device = device;

        Criteria<NDList, NDList> unetCriteria =
                Criteria.builder()
                        .setTypes(NDList.class, NDList.class)
                        .optModelPath(Paths.get(root + "lora_unet.pt"))
                        .optEngine("PyTorch")
