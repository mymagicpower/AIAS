...
public final class ControlNetSoftEdgeCpu {

    private ControlNetSoftEdgeCpu() {}
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("models/pytorch_cpu/", "controlnet_softedge.pt", Device.cpu());
             HedDetector detector = new HedDetector(512, 512, false, Device.cpu())) {
            ...
            ImageUtils.saveImage(result, "ctrlnet_softedge_hed_cpu.png", "output");
        }
