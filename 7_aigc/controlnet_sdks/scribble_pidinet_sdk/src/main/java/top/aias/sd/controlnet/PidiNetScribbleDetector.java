...
public final class PidiNetScribbleDetector implements AutoCloseable {
    ...
    public PidiNetScribbleDetector(int detect_resolution, int image_resolution, boolean safe, Device device) throws ModelException, IOException {
    ...
    private Criteria<Image, Image> ptCpuCriteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("models/cpu/pidi_cpu.pt"))
    ...
    private Criteria<Image, Image> ptGpuCriteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        .optEngine("PyTorch")
                        .setTypes(Image.class, Image.class)
                        .optModelPath(Paths.get("models/gpu/pidi_gpu.pt"))
                        .optTranslator(new FeatureTranslator())
                        .optDevice(device)
//                        .optOption("mapLocation","true")
    ...
    public Criteria<Image, Image> onnxCpuCriteria() {

        Criteria<Image, Image> criteria =
                Criteria.builder()
                        .optEngine("OnnxRuntime")
                        .setTypes(Image.class, Image.class)
                        .optModelName("pidi_traced_model")
                        .optModelPath(Paths.get("models/onnx/pidi_traced_model.onnx"))
