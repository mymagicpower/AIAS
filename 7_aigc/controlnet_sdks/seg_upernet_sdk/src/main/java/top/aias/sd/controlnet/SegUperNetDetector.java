...
public final class SegUperNetDetector implements AutoCloseable {
    ...
    public SegUperNetDetector(int detect_resolution, int image_resolution, boolean removeBg, Device device) throws ModelException, IOException {
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("models/upernet.pt"))
                        .optDevice(device)
