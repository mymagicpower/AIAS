...
public class ShuffleUtils {
    ...
    public static Image hwcContentShuffle(NDManager manager, Image image, int detect_resolution, int image_resolution) {
        ...
        org.opencv.core.Mat map1 = NDArrayUtils.floatNDArrayToMat(flow, 2);

        Image img = ImageFactory.getInstance().fromNDArray(array);
        org.opencv.core.Mat src = (org.opencv.core.Mat) img.getWrappedImage();
        org.opencv.core.Mat map2 = new Mat();
        org.opencv.core.Mat mat = OpenCVUtils.remap(src, map1, map2);
