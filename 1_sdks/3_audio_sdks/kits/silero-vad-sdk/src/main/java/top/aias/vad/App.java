...
public class App {
    ...
    private static final String EXAMPLE_WAV_FILE = "src/main/resources/1.wav";
    ...
    public static void fromWavFile(SileroVadDetector vadDetector, File wavFile) {
        ...
        for (SileroSpeechSegment speechSegment : speechTimeList) {
            ...
            System.out.println(String.format("start Offset: %d, end Offset: %d",
                    speechSegment.getStartOffset(), speechSegment.getEndOffset()));
        }
    }
}