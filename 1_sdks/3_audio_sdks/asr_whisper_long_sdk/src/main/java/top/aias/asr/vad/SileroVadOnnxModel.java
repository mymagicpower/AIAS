...
//            File f = new File("src/main/resources/add.onnx");
////            INDArray vx = Nd4j.scalar(1.0f).reshape(1,1);
////            INDArray vy = Nd4j.scalar(1.0f).reshape(1,1);
//            INDArray matrix = Nd4j.create(x);
//            INDArray rowVector = Nd4j.create(new long[]{sr});
//            INDArray matrixState = Nd4j.create(state);
//            OnnxRuntimeRunner onnxRuntimeRunner = OnnxRuntimeRunner.builder()
//                    .modelUri(f.getAbsolutePath())
//                    .build();
//            Map<String,INDArray> ndInputs = new LinkedHashMap<>();
//            ndInputs.put("input",matrix);
//            ndInputs.put("sr",rowVector);
//            ndInputs.put("state", matrixState);
//            Map<String, INDArray> exec = onnxRuntimeRunner.exec(ndInputs);
