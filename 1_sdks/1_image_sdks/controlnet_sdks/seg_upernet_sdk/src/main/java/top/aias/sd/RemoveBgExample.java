...
import top.aias.sd.controlnet.SegUperNetModel;
...
public final class RemoveBgExample {
    ...
    public static void main(String[] args) throws IOException, ModelException, TranslateException {
        ...
        String modelPath = "/Users/calvin/AIAS/3_api_platform/api-platform/models/controlnet/upernet.pt";

        try (SegUperNetModel model = new SegUperNetModel(512, 512, modelPath, true, 1, Device.cpu());
