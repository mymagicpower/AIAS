...
public final class SegUperNetModel implements AutoCloseable {
    ...
    public SegUperNetModel(int detect_resolution, int image_resolution, String modelPath, boolean removeBg, int poolSize, Device device) throws ModelException, IOException {
