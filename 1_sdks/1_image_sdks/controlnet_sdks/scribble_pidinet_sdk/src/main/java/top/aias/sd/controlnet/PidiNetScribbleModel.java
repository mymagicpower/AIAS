...
public final class PidiNetScribbleModel implements AutoCloseable {
    ...
    public PidiNetScribbleModel(int detect_resolution, int image_resolution, String modelPath, boolean safe, int poolSize, Device device) throws ModelException, IOException {
