...
public final class HedScribbleModel implements AutoCloseable {
    ...
    public HedScribbleModel(int detect_resolution, int image_resolution, String modelPath, boolean safe, int poolSize, Device device) throws ModelException, IOException {
