...
public final class PidiNetModel implements AutoCloseable {
    ...
    public PidiNetModel(int detect_resolution, int image_resolution, String modelPath, boolean safe, int poolSize, Device device) throws ModelException, IOException {
