...
public final class FaceModel implements AutoCloseable {
    ...
    private FacePool srPool;

    public FaceModel(String modelPath, String modelName, int poolSize, Device device) throws ModelException, IOException {
    ...
    public void init(String modelPath, String modelName, int poolSize, Device device) throws MalformedModelException, ModelNotFoundException, IOException {
        ...
        this.srPool = new FacePool(model, poolSize);
    }
