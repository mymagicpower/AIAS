 ...
 */
public class UltraLightFaceDetTranslator implements Translator<Image, DetectedObjects> {
    ...
    private int limit_side_len = 320; // 建议 640 , 320， 放大可以检测更多小脸

    public UltraLightFaceDetTranslator(
            double confThresh,
            double nmsThresh,
            double[] variance,
            int topK,
