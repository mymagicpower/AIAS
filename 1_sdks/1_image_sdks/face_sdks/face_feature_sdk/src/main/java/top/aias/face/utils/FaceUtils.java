...
public class FaceUtils {
    ...
    public static Image align(Image image, BoundingBox box) {
        ...
        Rectangle subImageRect =
                FaceUtils.getSubImageRect(rectangle, image.getWidth(), image.getHeight(), 0.5f);
...
//        ImageUtils.saveImage(subImage, "cropped_face.png", "build/output");
