 ...
 **/
public final class TextSrOnnx implements AutoCloseable {
    ...
    public TextSrOnnx(int detectResolution, Device device) throws ModelException, IOException {
        this.device = device;
    ...
    public Criteria<Image, Image> onnxCriteria() {
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        .optEngine("OnnxRuntime")
                        .optModelName("textbsr_traced_model")
                        .setTypes(Image.class, Image.class)
                        .optModelPath(Paths.get("models/textbsr_traced_model.onnx"))
