 ...
 **/
public final class Mpnet2VecModel implements AutoCloseable {
    ...
    public Mpnet2VecModel(String modelPath, String modelName, int poolSize) throws ModelNotFoundException, MalformedModelException, IOException {
