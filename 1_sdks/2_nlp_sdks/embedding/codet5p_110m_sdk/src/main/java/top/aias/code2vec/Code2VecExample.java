package top.aias.code2vec;

import ai.djl.ModelException;
import ai.djl.translate.TranslateException;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import top.aias.code2vec.utils.FeatureComparison;
import top.aias.code2vec.utils.codet5p2VecModel;
 ...
 */
public final class Code2VecExample {

    private static final Logger logger = LoggerFactory.getLogger(Code2VecExample.class);

    private Code2VecExample() {
    }
...
//    logger.info("input Sentence2: {}", input3);
        ...
        try (codet5p2VecModel text2VecModel = new codet5p2VecModel("models/", "codet5p-110m.pt", 1,1024)) {
