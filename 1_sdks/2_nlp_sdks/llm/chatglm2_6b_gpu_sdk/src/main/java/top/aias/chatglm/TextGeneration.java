...
//        String modelPath = "D:\\ai_projects\\products\\python\\chatglm2_6b_export\\traced_chatglm2_6b_fp32_cpu.pt";
        String modelPath = "/root/autodl-tmp/traced_chatglm2_6b_fp16_gpu.pt";

        try (ChatGLM2Model chatGLM2Model = new ChatGLM2Model(config, modelPath, Device.gpu());
            ...
            int tokenNum = output.toLongArray().length;
            logger.info("{} tokens/s", tokenNum/((end - start)/1000f));
