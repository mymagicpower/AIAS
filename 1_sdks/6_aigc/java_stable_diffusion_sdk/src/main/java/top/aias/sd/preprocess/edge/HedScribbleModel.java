package top.aias.sd.preprocess.edge;
 ...
 */
public final class HedScribbleModel implements AutoCloseable {
    ...
    public HedScribbleModel(int detect_resolution, int image_resolution, String modelPath, boolean safe, int poolSize, Device device) {
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(modelPath)) // hed.pt
                        .optDevice(device)
