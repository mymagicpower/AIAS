 ...
 */
public final class LineArtModel implements AutoCloseable {
    ...
    public LineArtModel(int detect_resolution, int image_resolution, String modelPath, int poolSize, Device device) {
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(modelPath)) // lineart.pt
                        .optDevice(device)
