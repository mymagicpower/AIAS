 ...
 */
public final class HedModel implements AutoCloseable {
    ...
    public HedModel(int detect_resolution, int image_resolution, String modelPath, boolean safe, int poolSize, Device device) {
