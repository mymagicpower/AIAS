...
public final class ControlNetPoseCpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("H:\\models\\aigc\\sd_cpu\\", "controlnet_openpose.pt", Device.cpu());
             PoseModel poseDetector = new PoseModel(512, 512, bodyModelPath, 1, Device.cpu());
             NDManager manager = NDManager.newBaseManager(Device.cpu());
             HandModel handDetector = new HandModel(handModelPath, 1, Device.cpu());
             FaceModel faceDetector = new FaceModel(faceModelPath, 1, Device.cpu());) {
