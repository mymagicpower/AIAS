 ...
 */
public final class MlsdModel implements AutoCloseable {
    ...
    public MlsdModel(int detect_resolution, int image_resolution, String modelPath, int poolSize, Device device) {
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(modelPath)) // mlsd.pt
                        .optDevice(device)
