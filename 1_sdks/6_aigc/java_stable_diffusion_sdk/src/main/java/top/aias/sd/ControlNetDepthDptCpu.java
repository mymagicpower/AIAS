...
import top.aias.sd.preprocess.depth.DptDepthModel;
...
public final class ControlNetDepthDptCpu {

    private ControlNetDepthDptCpu() {}
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        String modelPath = "models/dpt_depth.pt";
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("H:\\models\\aigc\\sd_cpu\\", "controlnet_depth.pt", Device.cpu());
             DptDepthModel detector = new DptDepthModel(512, 512, modelPath, 1, Device.cpu())) {
            Image depthImg = detector.predict(image);
            Image result = model.generateImage(depthImg, prompt, "", 25);
            ImageUtils.saveImage(result, "ctrlnet_dpt_depth_pt_cpu.png", "output");
        }
