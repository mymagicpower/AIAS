package top.aias.sd.preprocess.lineart;
 ...
 */
public final class LineArtCoarseModel implements AutoCloseable {
    ...
    public LineArtCoarseModel(int detect_resolution, int image_resolution, String modelPath, int poolSize, Device device) {
    ...
    public Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(modelPath)) // lineart_coarse.pt
                        .optDevice(device)
