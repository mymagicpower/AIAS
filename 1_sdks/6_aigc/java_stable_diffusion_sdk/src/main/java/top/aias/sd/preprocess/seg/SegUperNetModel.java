package top.aias.sd.preprocess.seg;
 ...
 */
public final class SegUperNetModel implements AutoCloseable {
    ...
    public SegUperNetModel(int detect_resolution, int image_resolution, String modelPath, boolean removeBg, int poolSize, Device device) {
    ...
    private Criteria<Image, Image> criteria() {
        ...
        Criteria<Image, Image> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(modelPath)) // upernet.pt
                        .optDevice(device)
    ...
    private final class FeatureTranslator implements Translator<Image, Image> {
        ...
        public Image processOutput(TranslatorContext ctx, NDList list) {
            ...
            for (int label = 0; label < ada_palette.length; label++) {
                ...
                if(removeBg){
                    if(b>0 || g > 0 || r >0){
                        bChannel.set(index, 1);
                        gChannel.set(index, 1);
                        rChannel.set(index, 1);
                    }
                }else {
