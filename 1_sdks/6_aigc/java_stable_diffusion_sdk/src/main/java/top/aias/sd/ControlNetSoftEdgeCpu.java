...
public final class ControlNetSoftEdgeCpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("H:\\models\\aigc\\sd_cpu\\", "controlnet_softedge.pt", Device.cpu());
            ...
            ImageUtils.saveImage(result, "ctrlnet_softedge_hed_cpu.png", "build/output");
        }
