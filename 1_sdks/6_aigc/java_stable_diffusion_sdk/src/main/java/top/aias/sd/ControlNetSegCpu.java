...
public final class ControlNetSegCpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try (StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("H:\\models\\aigc\\sd_cpu\\", "controlnet_seg.pt", Device.cpu());
             SegUperNetModel detector = new SegUperNetModel(512, 512, modelPath, false, 1, Device.cpu())) {
            ...
            ImageUtils.saveImage(result, "ctrlnet_seg_cpu.png", "build/output");
        }
