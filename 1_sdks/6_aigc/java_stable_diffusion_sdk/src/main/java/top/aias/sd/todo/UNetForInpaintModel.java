...
import top.aias.sd.pipelines.UNetPool;
 ...
 */
public final class UNetForInpaintModel implements AutoCloseable {
    ...
    public UNetForInpaintModel(String root, int poolSize, Device device) {
        this.root = root;
    ...
    private Criteria<NDList, NDList> criteria() {
        Criteria<NDList, NDList> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get(root + "unet_inpaint.pt"))
                        .optEngine("PyTorch")
