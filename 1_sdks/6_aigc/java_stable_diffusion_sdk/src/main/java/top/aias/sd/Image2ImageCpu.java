...
import top.aias.sd.pipelines.StableDiffusionImg2ImgPipeline;
...
public final class Image2ImageCpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try(StableDiffusionImg2ImgPipeline model = new StableDiffusionImg2ImgPipeline("H:\\models\\aigc\\sd_cpu\\", Device.cpu());){
            ...
            ImageUtils.saveImage(result, "img2img_pt_cpu.png", "build/output");
        }
    }
}