package top.aias.sd.preprocess.depth;
 ...
 */
public final class DptDepthModel implements AutoCloseable {
    ...
    public DptDepthModel(int detect_resolution, int image_resolution, String modelPath, int poolSize, Device device) {
