...
public final class ControlNetInpaintCpu {
    ...
    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        ...
        try(StableDiffusionControlNetPipeline model = new StableDiffusionControlNetPipeline("H:\\models\\aigc\\sd_cpu\\", "controlnet_inpaint.pt", Device.cpu());){
            Image result = model.generateImage(original_image,mask_image, prompt, negative_prompt, 25);
            ImageUtils.saveImage(result, "ctrlnet_inpaint_pt_cpu.png", "build/output");
        }
    }
}