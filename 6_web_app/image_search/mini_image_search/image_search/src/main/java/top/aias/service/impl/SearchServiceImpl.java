...
public class SearchServiceImpl implements SearchService {
    ...
    public List<DataInfoRes> search(String baseUrl, List<DataInfo> imageDataList, Integer topK, float[] vectorToSearch) {
        ...
        for (DataInfo dataInfo : imageDataList) {
            ...
            dataInfoRes.setId(dataInfo.getId());
            dataInfoRes.setScore(score);
            dataInfoRes.setPreName(dataInfo.getPreName());
            dataInfoRes.setRelativePath(dataInfo.getRelativePath());
            dataInfoRes.setFullPath(dataInfo.getFullPath());
