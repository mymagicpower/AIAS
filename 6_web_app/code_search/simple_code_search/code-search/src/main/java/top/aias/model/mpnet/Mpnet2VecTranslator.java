 ...
 */
public class Mpnet2VecTranslator implements Translator<String, float[]> {
    private final HuggingFaceTokenizer tokenizer;
    public Mpnet2VecTranslator(HuggingFaceTokenizer tokenizer){
...
//        tokenIdsArray.setName("token_type_ids");
        ...
        return new NDList(indicesArray, attentionMaskArray, placeholder);
    }
