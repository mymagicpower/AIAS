...
import top.aias.seg.model.pool.SegPool;
 ...
 */
public final class UNetHumanSegModel implements AutoCloseable {
    private ZooModel<Image, Image> model;
    private SegPool segPool;

    public UNetHumanSegModel(){}

    public UNetHumanSegModel(String modelPath, String modelName, int poolSize, boolean mask, Device device) throws ModelException, IOException {
