...
import top.aias.generate.CausalLMOutput;
import top.aias.generate.GreedyBatchTensorList;
import top.aias.generate.SearchConfig;
import top.aias.tokenizer.TokenUtils;
...
public final class NllbModel implements AutoCloseable {
    ...
    public void init(SearchConfig config, String modelPath, String modelName, int poolSize, Device device) throws MalformedModelException, ModelNotFoundException, IOException {
        this.config = config;
