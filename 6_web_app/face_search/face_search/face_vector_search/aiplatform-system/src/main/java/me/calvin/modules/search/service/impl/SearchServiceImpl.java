...
public class SearchServiceImpl implements SearchService {
    ...
    private static final String FACE_ID_FIELD = "faceId";
    ...
    public R<RpcStatus> createCollection(MilvusClient milvusClient, long timeoutMiliseconds) {
        ...
        FieldType fieldType3 = FieldType.newBuilder()
                .withName(FACE_ID_FIELD)
                .withDescription("face id")
    ...
    private R<GetCollectionStatisticsResponse> getCollectionStatistics(MilvusClient milvusClient) {
    ...
    // 插入向量
    public R<MutationResult> insert(List<Long> vectorIds, List<Integer> faceIds, List<List<Float>> vectors) {
        ...
        try {
            ...
            fields.add(new InsertParam.Field(FACE_ID_FIELD, faceIds));
    ...
    public R<QueryResults> query(String expr) {
        ...
        MilvusClient milvusClient = connPool.getConnection();
        try {
            List<String> fields = Arrays.asList(ID_FIELD, FACE_ID_FIELD);
            ...
            System.out.println(FACE_ID_FIELD + ":" + wrapper.getFieldWrapper(FACE_ID_FIELD).getFieldData().toString());
    ...
    public R<SearchResults> search(Integer topK, List<List<Float>> vectorsToSearch) {
        ...
        try {
            ...
            List<String> outFields = Collections.singletonList(FACE_ID_FIELD);
//            String searchExpr = FACE_ID_FIELD + " > 0";
