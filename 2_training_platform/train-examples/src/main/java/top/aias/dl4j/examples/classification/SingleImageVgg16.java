 ...
 */
public class SingleImageVgg16 {
    private static final Logger log = LoggerFactory.getLogger(SingleImageVgg16.class);
    private static final OpenCVFrameConverter.ToIplImage converter = new OpenCVFrameConverter.ToIplImage();

    // 模型路径
    private static String modelPath = new File(".").getAbsolutePath() + "/generated-models/VGG16_Garbage.zip";
    ...
    public static void main(String[] args) throws Exception {
        ...
        Vgg16Model model = new Vgg16Model();
        // 标签：模型输出分类
    ...
    public static ClassPrediction classify(Vgg16Model model, Mat image, List<String> labels) {
