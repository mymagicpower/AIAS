 ...
 */
public class TLFireSmoke {
    private static final Logger log = LoggerFactory.getLogger(TLFireSmoke.class);
    ...
    private static String modelFileName = modelFilePath + "TinyYOLO_fire_smoke_6.zip";
...
//                }
                ...
                if (tempScore > bestScore) {
                    ...
                    ModelSerializer.writeModel(computationGraph, modelFilePath + "TinyYOLO_fire_smoke_" + i + ".zip", true);
                }
            }
        }
