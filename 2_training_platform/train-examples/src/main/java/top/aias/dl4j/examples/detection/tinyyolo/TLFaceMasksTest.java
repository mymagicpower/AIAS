 ...
 */
public class TLFaceMasksTest {
    private static final Logger log = LoggerFactory.getLogger(TLFaceMasksTest.class);
    ...
    private static String modelFileName = modelFilePath + "TinyYOLO_facemask_81.zip";
...
//                }
                ...
                if (tempScore > bestScore ) {
                    ...
                    ModelSerializer.writeModel(computationGraph, modelFilePath + "TinyYOLO_facemask_" + i + ".zip", true);
                }
            }
        }
