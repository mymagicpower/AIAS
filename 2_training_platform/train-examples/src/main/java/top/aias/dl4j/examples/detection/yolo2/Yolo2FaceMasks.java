 ...
 */
public class Yolo2FaceMasks {
    private static final Logger log = LoggerFactory.getLogger(Yolo2FaceMasks.class);
    ...
    private static String modelFileName = modelFilePath + "facemask_yolov2.zip";
...
//        double[][] priorBoxes =  {{1, 4}, {2.5, 6}, {3, 1}, {3.5, 8}, {4, 9}};
        ...
        yolo2Model.setPriorBoxes(YOLO2.DEFAULT_PRIOR_BOXES);
        ...
        if (new File(modelFileName).exists()) {
            ...
            for (int i = 0; i < nEpochs; i++) {
                ...
                YoloEvaluator yoloEvaluator = new YoloEvaluator(yolo2Model.getComputationGraph(), yolo2Model.getTest(), testLabelProvider, yolo2Model.getWidth(), yolo2Model.getHeight());
                ...
                if (tempScore > bestScore) {
                    ...
                    ModelSerializer.writeModel(computationGraph, modelFilePath + "facemask_yolov2_" + i + ".zip", true);
                }
            }
        }
