 ...
 */
public class Y2ModelEvaluator {
    private static final Logger log = LoggerFactory.getLogger(top.aias.dl4j.examples.detection.tinyyolo.TLModelEvaluator.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String modelFileName = modelFilePath + "facemask_yolov2_2.zip";
