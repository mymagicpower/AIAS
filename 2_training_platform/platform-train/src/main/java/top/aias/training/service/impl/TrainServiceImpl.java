...
public class TrainServiceImpl implements TrainService {
	...
	public void train(UIServerInstance uiServer, TrainArgument trainArgument, String modelPath, String savePath, String dataRootPath){

		Training training=new Training(uiServer, trainArgument, modelPath, savePath, dataRootPath);
		// 运行训练程序
