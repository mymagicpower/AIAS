...
public class ImageUtil {
     ...
     */
    public static BufferedImage base64ToBufferedImage(String base64encodedString) {
        try {
            // 解码
    ...
    public static void base64ToImageFile(String base64ImgData, String filePath) throws IOException {
        // 解码
        byte[] base64decodedBytes = Base64.getDecoder().decode(base64ImgData);
        FileOutputStream os = new FileOutputStream(filePath);
        os.write(base64decodedBytes);
        os.close();
    }
