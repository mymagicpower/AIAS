...
import me.calvin.modules.search.common.face.FaceDetectionModel;
import me.calvin.modules.search.common.face.FaceObject;
import me.calvin.modules.search.common.face.FaceUtil;
...
public class DetectServiceImpl implements DetectService {
    ...
    public ImageInfoDto faceDetect(ImageInfo imageInfo) throws Exception {
        ...
        List<FaceObject> faceObjects = this.faceDetect(file.getName(), img);
    ...
    public List<FaceObject> faceDetect(String name, Image djlImg) throws TranslateException {
