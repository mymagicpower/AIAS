...
import crudFile from '@/api/search/search.js'
import CRUD, { presenter, header, form, crud } from '@crud/crud'
import EmptyData from '@/components/empty-data/EmptyData'
import tableMixin from '@/common/mixin/table-mixin'
import ImageCard from '@/views/imagesearch/search/component/image-card'

export default {
  name: 'PersonImageTable',
  components: { ImageCard, EmptyData },
  cruds() {
    return CRUD({ title: '文件', url: 'api/search', crudMethod: { ...crudFile }})
  },
  mixins: [presenter(), header(), crud(), tableMixin],
  data() {
    return {
