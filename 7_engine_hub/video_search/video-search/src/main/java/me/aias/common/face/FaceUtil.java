...
public class FaceUtil {
     ...
     * Returns a 100% expansion of the face, where factor = 1, 100%, factor = 0.2, 20%
     * */
    public static Rectangle getSubImageRect(
        ...
        // 外扩大100%，防止对齐后人脸出现黑边
        // Expand by 100% to prevent black edges on the aligned face
    ...
    public static double[][] pointsArray(Rectangle subImageRect, List<Point> points) {
        ...
        //      图中关键点坐标
        // Coordinates of key points in the image
        ...
        // 保存人脸关键点
        // Save the key points of the face
        for (int i = 0; i < 5; i++) {
