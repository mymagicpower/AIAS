...
import me.aias.domain.ImageInfoDto;
import me.aias.domain.SimpleFaceObject;
...
public class SearchServiceImpl implements SearchService {
    ...
    public void initSearchEngine() {
        ...
        // 检查 collection 是否存在
        HasCollectionResponse hasCollection = this.hasCollection(client, faceCollectionName);
    ...
    // 插入向量
    public void insertVectors(String collectionName, List<ImageInfoDto> list) {
        MilvusClient client = milvusConnector.getClient();
    ...
    // 插入向量
    public void insertVectors(String collectionName, ImageInfoDto imageInfo) {
        MilvusClient client = milvusConnector.getClient();
        List<Long> vectorIds = new ArrayList<>();
        List<List<Float>> vectors = new ArrayList<>();
        for (SimpleFaceObject faceObject : imageInfo.getFaceObjects()) {
