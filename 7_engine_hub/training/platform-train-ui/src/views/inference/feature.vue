...
<script>
import { featureForImageUrl } from '@/api/inference'
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        url: 'https://aias-home.oss-cn-beijing.aliyuncs.com/AIAS/train_platform/images/car.jpeg',
        result1: '',
        result2: '',
        base64Img: ''
      }
  ...
  methods: {
    upload() {
      return `${process.env.VUE_APP_BASE_API}/api/inference/featureForImageFile`
    },
    submitUpload() {
