 ...
 */
public final class MidUNetModel implements AutoCloseable {
    private ZooModel<Image, Image> model;
    private SegPool segPool;

    public MidUNetModel(){}

    public MidUNetModel(String modelPath, String modelName, int poolSize, boolean mask, Device device) throws ModelException, IOException {
