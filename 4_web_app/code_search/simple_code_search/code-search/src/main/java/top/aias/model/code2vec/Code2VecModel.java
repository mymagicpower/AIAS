package top.aias.model.code2vec;
...
public final class Code2VecModel implements CodeModel {
    ...
    public Code2VecModel(String modelPath, String modelName, int poolSize, int maxLength) throws ModelNotFoundException, MalformedModelException, IOException {
