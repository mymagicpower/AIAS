 ...
 **/
public final class Mpnet2VecModel implements CodeModel {
    private ZooModel<String, float[]> model;
    private CodeEncoderPool encoderPool;
    private HuggingFaceTokenizer tokenizer;

    public Mpnet2VecModel() {
    }

    public Mpnet2VecModel(String modelPath, String modelName, int poolSize, int maxLength) throws ModelNotFoundException, MalformedModelException, IOException {
    ...
    private Criteria<String, float[]> ptCriteria(String modelPath, String modelName) {
        Criteria<String, float[]> criteria =
                Criteria.builder()
                        ...
                        .optTranslator(new Mpnet2VecTranslator(tokenizer))
