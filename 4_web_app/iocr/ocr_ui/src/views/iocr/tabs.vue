  ...
  <el-tabs type="border-card">
      ...
      >
        <el-table-column label="请选择参照字段">
          <template slot-scope="scope">
            ...
            参考字段: <el-input v-model="scope.row.value" type="text" size="small" style="width:240px" />
          </template>
        </el-table-column>
      </el-table>
    </el-tab-pane>
    <el-tab-pane label="内容识别区">
      <el-table
        ...
        @row-click="handleChange"
      >
        <el-table-column label="请选择内容识别区">
          <template slot-scope="scope">
            <el-popconfirm
              confirm-button-text="确认"
              cancel-button-text="取消"
